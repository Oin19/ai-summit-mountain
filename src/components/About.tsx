    ...
    <section id="about" className="py-28 relative">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass text-xs font-medium text-neon mb-5">
            About the project
          </div>
          <h2 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight">
            An <span className="text-gradient">AI innovation initiative</span> for safer, smarter mountains.
          </h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl">
            This project was developed as an AI innovation initiative focused on improving
            accessibility, safety, and communication in remote mountainous regions.
          </p>
